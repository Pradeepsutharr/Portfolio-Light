...
import { skills, projects,UserData,profile } from "./Data.js";
...
const designation = document.querySelector('.typing-text');
const birthday = document.querySelector("time")
const address =  document.querySelector("address")
const email = document.querySelector(".contact-link")
const summary = this.document.querySelector(".profile-summary")

UserName.innerHTML = `${UserData[0].name}`
// designation.setAttribute('data-text',`${profile[0].designation}`);
birthday.innerHTML = `${UserData[1].birthday}`
address.innerHTML = `${UserData[3].location}`
email.innerHTML = `${UserData[2].email}`
summary.innerHTML = `${profile[1].summary}`
